...
- **Database Trainee** @ PT. Indocyber Global Teknologi *(Sep 2025 - Oct 2025)*: Focused on relational database design, data querying, and performance optimization.
- **UI/UX & Web Dev** @ PT. Kinema Systrans *(Feb 2024 - Jun 2024)*: End-to-end product research, wireframing, and frontend implementation.
